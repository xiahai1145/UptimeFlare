...
const pageConfig: PageConfig = {
  ...
  links: [
    { link: 'https://github.com/xiahai1145', label: 'GitHub' },
    { link: 'https://b23.tv/7v76rSI', label: 'bilibili' },
  ],
}
...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    // },
     {
      ...
      name: '博客',
      method: 'HEAD',
      target: 'https://www.hisea.us.ci/',
      statusPageLink: 'https://www.hisea.us.ci/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
     },
    {
      id: 'mc',
      name: 'Minecraft1.20.4服务器',
      method: 'HEAD',
      target: 'gm.rainplay.cn:11113',
      statusPageLink: 'gm.rainplay.cn:11113',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
     }
